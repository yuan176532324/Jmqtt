...
public class ProtocolProcessorTest {
    ...
    public void testPublishToMultipleSubscribers() throws InterruptedException {
        ...
        NettyChannelAssertions.assertConnAckAccepted(firstReceiverChannel);
        ...
        NettyChannelAssertions.assertConnAckAccepted(secondReceiverChannel);
    ...
    public void testPublishOfRetainedMessage_afterNewSubscription() throws Exception {
        ...
        m_processor.processConnect(m_channel, connectMessage);
        NettyChannelAssertions.assertConnAckAccepted(m_channel);
    ...
    public void testLowerTheQosToTheRequestedBySubscription() {
        ...
        Assert.assertEquals(MqttQoS.AT_LEAST_ONCE, ProtocolProcessor.lowerQosToTheSubscriptionDesired(subQos1, MqttQoS.EXACTLY_ONCE));

        Subscription subQos2 = new Subscription("Sub B", new Topic("a/+"), MqttQoS.EXACTLY_ONCE);
        Assert.assertEquals(MqttQoS.EXACTLY_ONCE, ProtocolProcessor.lowerQosToTheSubscriptionDesired(subQos2, MqttQoS.EXACTLY_ONCE));
    }
}
