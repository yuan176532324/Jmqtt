...
public class KafkaInterceptHandler extends AbstractInterceptHandler {
    ...
    private static final KafkaConfig kafkaConfig4p2p = new KafkaConfig(KAFKA_PRODUCER_FOR_P2P);
    private static final KafkaConfig kafkaConfig4conn = new KafkaConfig(KAFKA_PRODUCER_FOR_CONN);
