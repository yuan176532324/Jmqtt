...
import com.bigbigcloud.server.Constants;
...
public class MemorySessionStore implements ISessionsStore, ISubscriptionsStore {
    ...
    public ClientSession createNewSession(String clientID, boolean cleanSession) {
        ...
        session = new Session(clientID, new ClientSession(true, clientID, this, this, cleanSession));
    ...
    public ClientSession sessionForClient(String clientID) {
        ...
        return new ClientSession(true, clientID, this, this, storedSession.isCleanSession());
    }
    ...
    public Collection<ClientSession> getAllSessions() {
        ...
        for (Session entry : sessions.values()) {
            result.add(new ClientSession(true, entry.clientID, this, this, entry.persistentSession.get().isCleanSession()));
        }
        return result;
    }
