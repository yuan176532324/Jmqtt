...
package com.bigbigcloud.spi.impl.subscriptions;
...
public  class Subscription implements Serializable {
    ...
    public ISubscriptionsStore.ClientTopicCouple asClientTopicCouple() {
        return new ISubscriptionsStore.ClientTopicCouple(this.clientId, this.topicFilter);
    }
}
