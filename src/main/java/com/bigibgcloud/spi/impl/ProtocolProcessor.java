...
import com.bigibgcloud.interception.messages.InterceptAcknowledgedMessage;
import com.bigibgcloud.server.ConnectionDescriptor;
...
import static com.bigibgcloud.spi.impl.InternalRepublisher.createPublishForQos;
import static com.bigibgcloud.spi.impl.Utils.messageId;
import static com.bigibgcloud.spi.impl.Utils.readBytesAndRewind;
import static io.netty.handler.codec.mqtt.MqttConnectReturnCode.*;
import static io.netty.handler.codec.mqtt.MqttMessageIdVariableHeader.from;
import static io.netty.handler.codec.mqtt.MqttQoS.*;
import static com.bigibgcloud.server.ConnectionDescriptor.ConnectionState.*;
...
public class ProtocolProcessor {
    ...
    class WillMessage implements Serializable {
    ...
    private ConcurrentMap<String, WillMessage> m_willStore;
...
//        }
        ...
        m_willStore = RedissonUtil.getRedisson().getMap("willMessages");
...
//        }
        ...
        if (!sendAck(descriptor, msg, clientId)) {//发送ack，确认连接成功
            channel.close();
            return;
        }
        //发送连接成功事件
    ...
    private boolean republish(ConnectionDescriptor descriptor, MqttConnectMessage msg, ClientSession clientSession) {
        LOG.info("republish clientSession start {}", clientSession);
...
//        descriptor.setupAutoFlusher(flushIntervalMs);
        LOG.info("republish clientSession over {}", clientSession);
        return true;
    }
     ...
     */
    private void forwardPublishWill(WillMessage will, String clientID) throws IOException {
    ...
    public void processConnectionLost(String clientID, Channel channel) throws IOException {
     ...
     */
    public void processUnsubscribe(Channel channel, MqttUnsubscribeMessage msg) throws IOException {
    ...
    public void processSubscribe(Channel channel, MqttSubscribeMessage msg) throws IOException {
        String clientID = NettyUtils.clientID(channel);
        int messageID = messageId(msg);
