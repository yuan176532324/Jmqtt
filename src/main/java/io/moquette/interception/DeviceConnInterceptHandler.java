...
public class DeviceConnInterceptHandler extends AbstractInterceptHandler {

    private static final Logger LOG = LoggerFactory.getLogger(DeviceConnInterceptHandler.class);
    ...
    public void onConnect(InterceptConnectMessage msg) {
        ...
        kafkaMsg.setTopic(msg.getWillTopic());
